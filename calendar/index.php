...
.calendar-cell.entry-holiday {
    background: #fee2e2;
    border-color: #fca5a5;
}
.calendar-cell.entry-no_class {
    background: #fef3c7;
    border-color: #fcd34d;
}
.calendar-cell.entry-special_event {
    background: #e0f2fe;
    border-color: #7dd3fc;
}
.calendar-cell.entry-school_day {
    background: #d1fae5;
    border-color: #6ee7b7;
}
.entry-dot {
...
@media (max-width: 576px) {
    .calendar-cell { min-height: 45px; padding: 3px; }
